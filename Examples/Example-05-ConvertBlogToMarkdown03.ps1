...
# Get Content
$BlogContent = Invoke-WebRequest -Uri 'https://evotec.xyz/advanced-html-reporting-using-powershell/'
$BlogContent.Content | Out-File -FilePath $PSScriptRoot\Input\Example05.html
...
$Splat = @{
    ...
    Path                     = "$PSScriptRoot\Input\Example05.html"
    DestinationPath          = "$PSScriptRoot\Output\Example05.md"
    UnknownTags              = 'Bypass'
    GithubFlavored           = $true
    RemoveComments           = $true
